...
export type LinkedInState = {
  ...
  accountCreatedYear: string; // 4-digit year, "not_shown", or ""
...
export default function LinkedInCheck({
  ...
  return (
    <div className="rounded-[var(--radius-input)] border border-line bg-bg p-4">
      <h3 className="font-[family-name:var(--font-display)] text-sm font-medium text-ink">
        LinkedIn check
      </h3>
      <p className="mt-1 text-sm text-muted">
        Open the profile → More → &ldquo;About this profile&rdquo; and tell us what you see.
        &ldquo;Not sure&rdquo; is always fine — it never counts against.
      </p>
        ...
        <fieldset>
          ...
          <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
            <input
              ...
              className="w-28 rounded-[var(--radius-input)] border border-line bg-surface px-3 py-1.5 text-sm text-ink placeholder:text-muted"
            />
            <button
              type="button"
              role="radio"
      ...
      <div className="mt-4 border-t border-line pt-3">
        ...
        >
          More profile checks <span aria-hidden="true">{moreOpen ? "▴" : "▾"}</span>
        </button>
        {moreOpen && (
          <div className="mt-4 space-y-4">
            <TapSelect
              label="Does the profile's location match where they claim to be based or hiring?"
              hint={"location is shown in \u201CAbout this profile\u201D"}
            ...
            <TapSelect
              ...
              hint="check the company page's People tab"
